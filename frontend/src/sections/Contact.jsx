...
export default function Contact() {
    return (
        <section 
            id="contact"
            className='flex flex-col h-full items-center bg-linear-to-b from-(--color-blue-base) to-(--color-blue-dark) text-white pt-15 pb-25'
        >
            ...
            <div className='flex gap-10 mt-20'>
                ...
                <div 
                    className='flex gap-4 p-5 bg-(--color-blue-light2)/50 items-center font-bold rounded-2xl cursor-pointer text-white/95 
                    hover:-translate-y-1 hover:bg-(--color-blue-light2)/30 transition
                '>
                ...
                <div className='
                    flex gap-4 p-5 bg-(--color-blue-base) items-center font-bold rounded-2xl cursor-pointer text-white/80
                    hover:-translate-y-1 hover:bg-(--color-blue-light2)/30 transition
                '>
            ...
            <div 
                className='flex gap-4 p-5 bg-(--color-blue-dark) border border-(--color-blue-light2)/30 items-center rounded-2xl text-white/80 mt-10'
            >
