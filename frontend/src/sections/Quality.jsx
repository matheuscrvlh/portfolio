...
export default function Quality() {
    return (
        <section className='flex flex-col items-center bg-(--color-blue-dark) h-full text-white pt-5 pb-20'>
            <h2 className='text-(--color-blue-light) text-5xl font-bold mt-10'>Qualidade que Gera Resultado</h2>
            ...
            <div className='flex flex-col gap-5'>
                ...
                <hr className='border-(--color-blue-light2)/40' />
                <div className='flex gap-10 h-full p-4 items-center'>
                    <p className='text-3xl font-semibold w-100'>Código Estratégico</p>
                    <p className='w-100 text-white/75'>Código limpo, organizado e escalável, seguindo boas práticas para garantir manutenção fácil e crescimento do projeto.</p>
                    <MoveDownRight className='cursor-pointer'/>
                </div>
                <hr className='border-(--color-blue-light2)/40' />
                <div className='flex gap-10 h-full p-4 items-center'>
